...
const ATT_EVENTS=[
  {id:1, date:"Di 27.05.", time:"17:30", type:"Training",      ort:"Platz A – Herrliberg",  team:"Cc-Junioren", deadline:"Mo 26.05.2026, 20:00"},
  {id:12,date:"Fr 23.05.", time:"17:30", type:"Training",      ort:"Platz A – Herrliberg",  team:"Cc-Junioren", deadline:"Do 22.05.2026, 20:00"},
  {id:2, date:"Sa 24.05.", time:"10:00", type:"Spiel",         ort:"Sportanlage Aabach",     team:"Cc-Junioren", opponent:"FC Küsnacht",  deadline:"Fr 23.05.2026, 20:00", treffpunkt:"09:15 Sportanlage Aabach"},
  {id:3, date:"Di 20.05.", time:"17:30", type:"Training",      ort:"Platz A – Herrliberg",  team:"Cc-Junioren", deadline:"Mo 19.05.2026, 20:00"},
  {id:14,date:"Fr 16.05.", time:"17:30", type:"Training",      ort:"Platz A – Herrliberg",  team:"Cc-Junioren", deadline:"Do 15.05.2026, 20:00"},
  {id:4, date:"Sa 17.05.", time:"10:00", type:"Spiel",         ort:"Sportplatz Thalwil",     team:"Cc-Junioren", opponent:"FC Thalwil",    deadline:"Do 15.05.2026, 20:00", treffpunkt:"09:15 Sportanlage Aabach"},
  {id:5, date:"Di 13.05.", time:"17:30", type:"Training",      ort:"Platz B – Herrliberg",  team:"Cc-Junioren", deadline:"Mo 12.05.2026, 20:00"},
  {id:16,date:"Fr 09.05.", time:"17:30", type:"Training",      ort:"Platz A – Herrliberg",  team:"Cc-Junioren", deadline:"Do 08.05.2026, 20:00"},
  {id:6, date:"Sa 10.05.", time:"09:30", type:"Spiel",         ort:"Sportanlage Aabach",     team:"Cc-Junioren", opponent:"FC Rapperswil", deadline:"Do 08.05.2026, 20:00", treffpunkt:"09:00 Sportanlage Aabach"},
  {id:7, date:"Di 06.05.", time:"17:30", type:"Training",      ort:"Platz A – Herrliberg",  team:"Cc-Junioren", deadline:"Mo 05.05.2026, 20:00"},
  {id:18,date:"Fr 02.05.", time:"17:30", type:"Training",      ort:"Platz A – Herrliberg",  team:"Cc-Junioren", deadline:"Do 01.05.2026, 20:00"},
  {id:20,date:"Fr 30.05.", time:"17:30", type:"Training",      ort:"Platz A – Herrliberg",  team:"Cc-Junioren", deadline:"Do 29.05.2026, 20:00"},
  {id:22,date:"Di 03.06.", time:"17:30", type:"Training",      ort:"Platz A – Herrliberg",  team:"Cc-Junioren", deadline:"Mo 02.06.2026, 20:00"},
  {id:23,date:"Fr 06.06.", time:"17:30", type:"Training",      ort:"Platz A – Herrliberg",  team:"Cc-Junioren", deadline:"Do 05.06.2026, 20:00"},
  {id:8, date:"Di 10.06.", time:"19:00", type:"Veranstaltung", subtype:"Team-Event",    ort:"Vereinslokal",   team:"Cc-Junioren", title:"Elternabend Cc-Junioren", deadline:"Di 03.06.2026, 18:00", beschreibung:"Wir laden alle Eltern herzlich zum Elternabend ein. Themen: Spielphilosophie, Trainingsplan Saisonabschluss und offene Fragen. Bitte bis zur Deadline rückmelden."},
  {id:9, date:"Fr 20.06.", time:"18:30", type:"Veranstaltung", subtype:"Team-Event",    ort:"Vereinslokal",   team:"Cc-Junioren", title:"Saisonabschluss",          deadline:"Mo 16.06.2026, 18:00", beschreibung:"Der gemeinsame Saisonabschluss der Cc-Junioren mit Apéro und Rückblick auf die Saison 2024/25. Eltern und Geschwister sind herzlich willkommen."},
  {id:10,date:"Mi 25.06.", time:"19:30", type:"Veranstaltung", subtype:"Vereinsanlass", ort:"Mehrzweckhalle", team:"Alle", title:"Generalversammlung", deadline:"Fr 20.06.2026, 18:00", rsvp:true, beschreibung:"Jährliche Generalversammlung des FC Herrliberg. Traktanden: Jahresbericht, Finanzen, Wahlen, Diverses. Alle Mitglieder sind herzlich eingeladen."},
  {id:11,date:"Sa 14.06.", endDate:"So 15.06.", time:"09:00", type:"Veranstaltung", subtype:"Vereinsanlass", ort:"Sportanlage Aabach", team:"Alle", title:"Grümpelturnier 2026", rsvp:false, beschreibung:"Das traditionelle Grümpelturnier des FC Herrliberg findet auf der Sportanlage Aabach statt. Alle Teams sind vertreten – Helfer gesucht! Anmeldung über das Helfermodul."},
  /* ── 1. Mannschaft Herren ── */
  {id:20, date:"Di 27.05.", time:"19:00", type:"Training", ort:"Platz A – Herrliberg", team:"1. Mannschaft Herren", deadline:"Mo 26.05.2026, 18:00"},
  {id:21, date:"Sa 24.05.", time:"15:00", type:"Spiel",    ort:"Sportanlage Grünfeld, Rapperswil", team:"1. Mannschaft Herren", opponent:"FC Rapperswil", deadline:"Fr 23.05.2026, 18:00", treffpunkt:"14:15 Bahnhof Herrliberg"},
  {id:22, date:"Fr 23.05.", time:"19:00", type:"Training", ort:"Platz A – Herrliberg", team:"1. Mannschaft Herren", deadline:"Do 22.05.2026, 18:00"},
  {id:23, date:"Sa 17.05.", time:"15:00", type:"Spiel",    ort:"Sportanlage Aabach",  team:"1. Mannschaft Herren", opponent:"FC Horgen",     deadline:"Do 15.05.2026, 18:00", treffpunkt:"14:30 Sportanlage Aabach"},
  {id:24, date:"Di 13.05.", time:"19:00", type:"Training", ort:"Platz A – Herrliberg", team:"1. Mannschaft Herren", deadline:"Mo 12.05.2026, 18:00"},
  {id:28, date:"Do 07.05.", time:"19:00", type:"Training", ort:"Platz A – Herrliberg", team:"1. Mannschaft Herren", deadline:"Mi 06.05.2026, 18:00"},
  {id:29, date:"Di 06.05.", time:"19:00", type:"Training", ort:"Platz A – Herrliberg", team:"1. Mannschaft Herren", deadline:"Mo 05.05.2026, 18:00"},
  {id:35, date:"Do 21.05.", time:"19:00", type:"Training", ort:"Platz A – Herrliberg", team:"1. Mannschaft Herren", deadline:"Mi 20.05.2026, 18:00"},
  {id:36, date:"Di 20.05.", time:"19:00", type:"Training", ort:"Platz A – Herrliberg", team:"1. Mannschaft Herren", deadline:"Mo 19.05.2026, 18:00"},
  {id:37, date:"Do 14.05.", time:"19:00", type:"Training", ort:"Platz A – Herrliberg", team:"1. Mannschaft Herren", deadline:"Mi 13.05.2026, 18:00"},
  {id:25, date:"Sa 10.05.", time:"15:00", type:"Spiel",    ort:"Sportanlage Aabach",  team:"1. Mannschaft Herren", opponent:"SC Wädenswil",  deadline:"Do 08.05.2026, 18:00", treffpunkt:"14:30 Sportanlage Aabach"},
  {id:26, date:"Sa 31.05.", time:"15:00", type:"Spiel",    ort:"Sportplatz Buchholz, Uster", team:"1. Mannschaft Herren", opponent:"FC Uster", deadline:"Fr 29.05.2026, 18:00", treffpunkt:"14:15 Bahnhof Herrliberg"},
  {id:27, date:"Fr 12.06.", time:"20:00", type:"Veranstaltung", subtype:"Team-Event", ort:"Vereinslokal", team:"1. Mannschaft Herren", title:"Saisonabschluss Herren", deadline:"Mi 10.06.2026, 18:00", beschreibung:"Gemeinsamer Saisonabschluss mit Nachtessen. Bitte bis zur Deadline rückmelden."},
  /* ── 1. Mannschaft Frauen ── */
  {id:30, date:"Mi 27.05.", time:"20:00", type:"Training", ort:"Platz B – Herrliberg", team:"1. Mannschaft Frauen", deadline:"Di 26.05.2026, 18:00"},
  {id:31, date:"Sa 24.05.", time:"14:00", type:"Spiel",    ort:"Sportanlage Aabach",   team:"1. Mannschaft Frauen", opponent:"FC Küsnacht Frauen", deadline:"Fr 23.05.2026, 12:00", treffpunkt:"13:30 Sportanlage Aabach"},
  {id:32, date:"Mi 20.05.", time:"20:00", type:"Training", ort:"Platz B – Herrliberg", team:"1. Mannschaft Frauen", deadline:"Di 19.05.2026, 18:00"},
  {id:33, date:"Sa 17.05.", time:"14:00", type:"Spiel",    ort:"Sportanlage Aabach",   team:"1. Mannschaft Frauen", opponent:"FC Uster Frauen",   deadline:"Do 15.05.2026, 12:00", treffpunkt:"13:30 Sportanlage Aabach"},
  {id:36, date:"Mi 13.05.", time:"20:00", type:"Training", ort:"Platz B – Herrliberg", team:"1. Mannschaft Frauen", deadline:"Di 12.05.2026, 18:00"},
  {id:37, date:"Mi 06.05.", time:"20:00", type:"Training", ort:"Platz B – Herrliberg", team:"1. Mannschaft Frauen", deadline:"Di 05.05.2026, 18:00"},
  {id:38, date:"Sa 10.05.", time:"14:00", type:"Spiel",    ort:"Sportplatz Uster",     team:"1. Mannschaft Frauen", opponent:"FC Adliswil Frauen", deadline:"Do 08.05.2026, 12:00", treffpunkt:"13:15 Bahnhof Herrliberg"},
  {id:39, date:"Mi 29.04.", time:"20:00", type:"Training", ort:"Platz B – Herrliberg", team:"1. Mannschaft Frauen", deadline:"Di 28.04.2026, 18:00"},
  {id:34, date:"Sa 07.06.", time:"14:00", type:"Spiel",    ort:"Sportplatz Männedorf",  team:"1. Mannschaft Frauen", opponent:"SC Männedorf Frauen", deadline:"Fr 06.06.2026, 12:00", treffpunkt:"13:15 Bahnhof Herrliberg"},
  {id:35, date:"Do 18.06.", time:"19:30", type:"Veranstaltung", subtype:"Team-Event", ort:"Vereinslokal", team:"1. Mannschaft Frauen", title:"Saisonrückblick Frauen", deadline:"Di 16.06.2026, 18:00", beschreibung:"Saisonrückblick mit Apéro. Alle Spielerinnen und Betreuer sind herzlich eingeladen."},
  /* ── Ca-Junioren ── */
  {id:40, date:"Do 28.05.", time:"17:30", type:"Training", ort:"Platz B – Herrliberg", team:"Ca-Junioren", deadline:"Mi 27.05.2026, 20:00"},
  {id:41, date:"Sa 31.05.", time:"10:00", type:"Spiel",    ort:"Sportanlage Aabach",   team:"Ca-Junioren", opponent:"FC Thalwil U13", deadline:"Fr 29.05.2026, 20:00", treffpunkt:"09:30 Sportanlage Aabach"},
  {id:42, date:"Do 21.05.", time:"17:30", type:"Training", ort:"Platz B – Herrliberg", team:"Ca-Junioren", deadline:"Mi 20.05.2026, 20:00"},
  {id:46, date:"Do 14.05.", time:"17:30", type:"Training", ort:"Platz B – Herrliberg", team:"Ca-Junioren", deadline:"Mi 13.05.2026, 20:00"},
  {id:47, date:"Do 07.05.", time:"17:30", type:"Training", ort:"Platz B – Herrliberg", team:"Ca-Junioren", deadline:"Mi 06.05.2026, 20:00"},
  {id:48, date:"Sa 09.05.", time:"10:00", type:"Spiel",    ort:"Sportanlage Aabach",   team:"Ca-Junioren", opponent:"FC Stäfa U13",   deadline:"Do 07.05.2026, 20:00", treffpunkt:"09:30 Sportanlage Aabach"},
  {id:49, date:"Sa 02.05.", time:"10:00", type:"Spiel",    ort:"Sportplatz Männedorf",  team:"Ca-Junioren", opponent:"SC Männedorf U13",deadline:"Do 30.04.2026, 20:00", treffpunkt:"09:15 Bahnhof Herrliberg"},
  {id:43, date:"Sa 17.05.", time:"10:00", type:"Spiel",    ort:"Sportplatz Küsnacht",  team:"Ca-Junioren", opponent:"FC Küsnacht U13", deadline:"Do 15.05.2026, 20:00", treffpunkt:"09:15 Bahnhof Herrliberg"},
  {id:44, date:"Sa 14.06.", time:"10:00", type:"Spiel",    ort:"Sportanlage Aabach",   team:"Ca-Junioren", opponent:"FC Rapperswil U13", deadline:"Fr 12.06.2026, 20:00", treffpunkt:"09:30 Sportanlage Aabach"},
  {id:45, date:"Di 16.06.", time:"19:00", type:"Veranstaltung", subtype:"Team-Event",  ort:"Vereinslokal", team:"Ca-Junioren", title:"Elternabend Ca-Junioren", deadline:"So 14.06.2026, 18:00", beschreibung:"Elternabend der Ca-Junioren. Themen: Saisonbilanz, Kaderplanung nächste Saison, Trainingszeiten."},
  /* ── D-Juniorinnen ── */
  {id:50, date:"Mo 27.04.", time:"17:00", type:"Training", ort:"Platz C – Herrliberg", team:"D-Juniorinnen", deadline:"So 26.04.2026, 18:00"},
  {id:51, date:"Mo 04.05.", time:"17:00", type:"Training", ort:"Platz C – Herrliberg", team:"D-Juniorinnen", deadline:"So 03.05.2026, 18:00"},
  {id:52, date:"Sa 09.05.", time:"09:30", type:"Spiel",    ort:"Sportanlage Aabach",  team:"D-Juniorinnen", opponent:"FC Küsnacht Mädchen", deadline:"Do 07.05.2026, 18:00", treffpunkt:"09:00 Sportanlage Aabach"},
  {id:53, date:"Mo 11.05.", time:"17:00", type:"Training", ort:"Platz C – Herrliberg", team:"D-Juniorinnen", deadline:"So 10.05.2026, 18:00"},
  {id:54, date:"Mo 18.05.", time:"17:00", type:"Training", ort:"Platz C – Herrliberg", team:"D-Juniorinnen", deadline:"So 17.05.2026, 18:00"},
  {id:55, date:"Sa 16.05.", time:"09:30", type:"Spiel",    ort:"Sportplatz Thalwil",  team:"D-Juniorinnen", opponent:"SC Wädenswil Mädchen", deadline:"Do 14.05.2026, 18:00", treffpunkt:"09:00 Bahnhof Herrliberg"},
  {id:56, date:"Mo 26.05.", time:"17:00", type:"Training", ort:"Platz C – Herrliberg", team:"D-Juniorinnen", deadline:"So 25.05.2026, 18:00"},
  {id:57, date:"Mo 02.06.", time:"17:00", type:"Training", ort:"Platz C – Herrliberg", team:"D-Juniorinnen", deadline:"So 01.06.2026, 18:00"},
  {id:58, date:"Sa 07.06.", time:"09:30", type:"Spiel",    ort:"Sportanlage Aabach",  team:"D-Juniorinnen", opponent:"FC Zollikon Mädchen", deadline:"Do 05.06.2026, 18:00", treffpunkt:"09:00 Sportanlage Aabach"},
  /* ── 2. Mannschaft Herren ── */
  {id:60, date:"Mi 07.05.", time:"20:00", type:"Training", ort:"Platz A – Herrliberg", team:"2. Mannschaft Herren", deadline:"Di 06.05.2026, 20:00"},
  {id:61, date:"Sa 10.05.", time:"15:00", type:"Spiel",    ort:"Sportplatz Adliswil",  team:"2. Mannschaft Herren", opponent:"FC Adliswil 2",    deadline:"Do 08.05.2026, 20:00", treffpunkt:"14:15 Bahnhof Herrliberg"},
  {id:62, date:"Mi 14.05.", time:"20:00", type:"Training", ort:"Platz A – Herrliberg", team:"2. Mannschaft Herren", deadline:"Di 13.05.2026, 20:00"},
  {id:63, date:"Sa 17.05.", time:"15:00", type:"Spiel",    ort:"Sportanlage Aabach",   team:"2. Mannschaft Herren", opponent:"SC Wädenswil 2",   deadline:"Do 15.05.2026, 20:00", treffpunkt:"14:15 Sportanlage Aabach"},
  {id:64, date:"Mi 21.05.", time:"20:00", type:"Training", ort:"Platz A – Herrliberg", team:"2. Mannschaft Herren", deadline:"Di 20.05.2026, 20:00"},
  {id:65, date:"Mi 28.05.", time:"20:00", type:"Training", ort:"Platz A – Herrliberg", team:"2. Mannschaft Herren", deadline:"Di 27.05.2026, 20:00"},
  {id:66, date:"Sa 31.05.", time:"15:00", type:"Spiel",    ort:"Sportanlage Aabach",   team:"2. Mannschaft Herren", opponent:"FC Thalwil 2",     deadline:"Do 29.05.2026, 20:00", treffpunkt:"14:15 Sportanlage Aabach"},
  {id:67, date:"Mi 04.06.", time:"20:00", type:"Training", ort:"Platz A – Herrliberg", team:"2. Mannschaft Herren", deadline:"Di 03.06.2026, 20:00"},
  /* ── Da-Junioren ── */
  {id:70, date:"Di 06.05.", time:"17:00", type:"Training", ort:"Platz B – Herrliberg", team:"Da-Junioren", deadline:"Mo 05.05.2026, 18:00"},
  {id:71, date:"Sa 10.05.", time:"10:00", type:"Spiel",    ort:"Sportanlage Aabach",   team:"Da-Junioren", opponent:"FC Stäfa U13",   deadline:"Do 08.05.2026, 18:00", treffpunkt:"09:30 Sportanlage Aabach"},
  {id:72, date:"Di 13.05.", time:"17:00", type:"Training", ort:"Platz B – Herrliberg", team:"Da-Junioren", deadline:"Mo 12.05.2026, 18:00"},
  {id:73, date:"Di 20.05.", time:"17:00", type:"Training", ort:"Platz B – Herrliberg", team:"Da-Junioren", deadline:"Mo 19.05.2026, 18:00"},
  {id:74, date:"Di 27.05.", time:"17:00", type:"Training", ort:"Platz B – Herrliberg", team:"Da-Junioren", deadline:"Mo 26.05.2026, 18:00"},
  {id:75, date:"Sa 07.06.", time:"10:00", type:"Spiel",    ort:"Sportplatz Küsnacht",  team:"Da-Junioren", opponent:"FC Küsnacht U13", deadline:"Do 05.06.2026, 18:00", treffpunkt:"09:15 Bahnhof Herrliberg"},
  /* ── Db-Junioren ── */
  {id:80, date:"Do 07.05.", time:"17:00", type:"Training", ort:"Platz C – Herrliberg", team:"Db-Junioren", deadline:"Mi 06.05.2026, 18:00"},
  {id:81, date:"Sa 10.05.", time:"11:30", type:"Spiel",    ort:"Sportanlage Aabach",   team:"Db-Junioren", opponent:"FC Männedorf U13", deadline:"Do 08.05.2026, 18:00", treffpunkt:"11:00 Sportanlage Aabach"},
  {id:82, date:"Do 14.05.", time:"17:00", type:"Training", ort:"Platz C – Herrliberg", team:"Db-Junioren", deadline:"Mi 13.05.2026, 18:00"},
  {id:83, date:"Do 21.05.", time:"17:00", type:"Training", ort:"Platz C – Herrliberg", team:"Db-Junioren", deadline:"Mi 20.05.2026, 18:00"},
  {id:84, date:"Do 28.05.", time:"17:00", type:"Training", ort:"Platz C – Herrliberg", team:"Db-Junioren", deadline:"Mi 27.05.2026, 18:00"},
  {id:85, date:"Sa 06.06.", time:"10:00", type:"Spiel",    ort:"Sportplatz Uetikon",   team:"Db-Junioren", opponent:"FC Stäfa U13 B",  deadline:"Do 04.06.2026, 18:00", treffpunkt:"09:15 Bahnhof Herrliberg"},
  /* ── Ba-Junioren ── */
  {id:90, date:"Mi 06.05.", time:"17:30", type:"Training", ort:"Platz B – Herrliberg", team:"Ba-Junioren", deadline:"Di 05.05.2026, 18:00"},
  {id:91, date:"Sa 10.05.", time:"13:30", type:"Spiel",    ort:"Sportanlage Aabach",   team:"Ba-Junioren", opponent:"FC Küsnacht U15", deadline:"Do 08.05.2026, 18:00", treffpunkt:"13:00 Sportanlage Aabach"},
  {id:92, date:"Mi 13.05.", time:"17:30", type:"Training", ort:"Platz B – Herrliberg", team:"Ba-Junioren", deadline:"Di 12.05.2026, 18:00"},
  {id:93, date:"Mi 20.05.", time:"17:30", type:"Training", ort:"Platz B – Herrliberg", team:"Ba-Junioren", deadline:"Di 19.05.2026, 18:00"},
  {id:94, date:"Mi 27.05.", time:"17:30", type:"Training", ort:"Platz B – Herrliberg", team:"Ba-Junioren", deadline:"Di 26.05.2026, 18:00"},
  {id:95, date:"Sa 31.05.", time:"13:30", type:"Spiel",    ort:"Sportplatz Thalwil",   team:"Ba-Junioren", opponent:"SC Männedorf U15",deadline:"Do 29.05.2026, 18:00", treffpunkt:"13:00 Bahnhof Herrliberg"},
  /* ── Bb-Junioren ── */
  {id:100,date:"Di 05.05.", time:"17:30", type:"Training", ort:"Platz D – Herrliberg", team:"Bb-Junioren", deadline:"Mo 04.05.2026, 18:00"},
  {id:101,date:"Di 12.05.", time:"17:30", type:"Training", ort:"Platz D – Herrliberg", team:"Bb-Junioren", deadline:"Mo 11.05.2026, 18:00"},
  {id:102,date:"Sa 16.05.", time:"10:00", type:"Spiel",    ort:"Sportanlage Aabach",   team:"Bb-Junioren", opponent:"FC Uster U15 B",  deadline:"Do 14.05.2026, 18:00", treffpunkt:"09:30 Sportanlage Aabach"},
  {id:103,date:"Di 19.05.", time:"17:30", type:"Training", ort:"Platz D – Herrliberg", team:"Bb-Junioren", deadline:"Mo 18.05.2026, 18:00"},
  {id:104,date:"Di 26.05.", time:"17:30", type:"Training", ort:"Platz D – Herrliberg", team:"Bb-Junioren", deadline:"Mo 25.05.2026, 18:00"},
  {id:105,date:"Sa 30.05.", time:"10:00", type:"Spiel",    ort:"Sportplatz Männedorf",  team:"Bb-Junioren", opponent:"SC Männedorf U15 B",deadline:"Do 28.05.2026, 18:00", treffpunkt:"09:15 Bahnhof Herrliberg"},
  /* ── A-Junioren ── */
  {id:110,date:"Di 05.05.", time:"18:00", type:"Training", ort:"Platz A – Herrliberg", team:"A-Junioren",  deadline:"Mo 04.05.2026, 18:00"},
  {id:111,date:"Fr 09.05.", time:"18:00", type:"Training", ort:"Platz A – Herrliberg", team:"A-Junioren",  deadline:"Do 08.05.2026, 18:00"},
  {id:112,date:"Sa 10.05.", time:"14:00", type:"Spiel",    ort:"Sportanlage Aabach",   team:"A-Junioren",  opponent:"FC Küsnacht U16", deadline:"Do 08.05.2026, 18:00", treffpunkt:"13:15 Sportanlage Aabach"},
  {id:113,date:"Di 12.05.", time:"18:00", type:"Training", ort:"Platz A – Herrliberg", team:"A-Junioren",  deadline:"Mo 11.05.2026, 18:00"},
  {id:114,date:"Di 19.05.", time:"18:00", type:"Training", ort:"Platz A – Herrliberg", team:"A-Junioren",  deadline:"Mo 18.05.2026, 18:00"},
  {id:115,date:"Di 26.05.", time:"18:00", type:"Training", ort:"Platz A – Herrliberg", team:"A-Junioren",  deadline:"Mo 25.05.2026, 18:00"},
  {id:116,date:"Sa 28.05.", time:"14:00", type:"Spiel",    ort:"Sportplatz Zollikon",  team:"A-Junioren",  opponent:"FC Zollikon U16", deadline:"Do 26.05.2026, 18:00", treffpunkt:"13:15 Bahnhof Herrliberg"},
  /* ── C-Juniorinnen ── */
  {id:120,date:"Mi 06.05.", time:"17:00", type:"Training", ort:"Platz C – Herrliberg", team:"C-Juniorinnen",deadline:"Di 05.05.2026, 18:00"},
  {id:121,date:"Sa 09.05.", time:"10:00", type:"Spiel",    ort:"Sportanlage Aabach",   team:"C-Juniorinnen",opponent:"FC Stäfa Mädchen U13",deadline:"Do 07.05.2026, 18:00", treffpunkt:"09:30 Sportanlage Aabach"},
  {id:122,date:"Mi 13.05.", time:"17:00", type:"Training", ort:"Platz C – Herrliberg", team:"C-Juniorinnen",deadline:"Di 12.05.2026, 18:00"},
  {id:123,date:"Mi 20.05.", time:"17:00", type:"Training", ort:"Platz C – Herrliberg", team:"C-Juniorinnen",deadline:"Di 19.05.2026, 18:00"},
  {id:124,date:"Mi 27.05.", time:"17:00", type:"Training", ort:"Platz C – Herrliberg", team:"C-Juniorinnen",deadline:"Di 26.05.2026, 18:00"},
  {id:125,date:"Sa 30.05.", time:"10:00", type:"Spiel",    ort:"Sportplatz Küsnacht",  team:"C-Juniorinnen",opponent:"FC Küsnacht Mädchen U13",deadline:"Do 28.05.2026, 18:00", treffpunkt:"09:15 Bahnhof Herrliberg"},
  /* ── E-Juniorinnen ── */
  {id:130,date:"Sa 09.05.", time:"09:00", type:"Spiel",    ort:"Sportanlage Aabach",   team:"E-Juniorinnen",opponent:"Spielfest Küsnacht",deadline:"Do 07.05.2026, 18:00", treffpunkt:"08:30 Sportanlage Aabach"},
  {id:131,date:"Mi 13.05.", time:"16:30", type:"Training", ort:"Platz D – Herrliberg", team:"E-Juniorinnen",deadline:"Di 12.05.2026, 18:00"},
  {id:135,date:"Mi 06.05.", time:"16:30", type:"Training", ort:"Platz D – Herrliberg", team:"E-Juniorinnen",deadline:"Di 05.05.2026, 18:00"},
  {id:132,date:"Mi 20.05.", time:"16:30", type:"Training", ort:"Platz D – Herrliberg", team:"E-Juniorinnen",deadline:"Di 19.05.2026, 18:00"},
  {id:133,date:"Mi 27.05.", time:"16:30", type:"Training", ort:"Platz D – Herrliberg", team:"E-Juniorinnen",deadline:"Di 26.05.2026, 18:00"},
  {id:134,date:"Sa 13.06.", time:"09:00", type:"Spiel",    ort:"Sportanlage Aabach",   team:"E-Juniorinnen",opponent:"Spielfest Herrliberg",deadline:"Do 11.06.2026, 18:00", treffpunkt:"08:30 Sportanlage Aabach"},
  /* ── F-Juniorinnen ── */
  {id:140,date:"Sa 16.05.", time:"09:00", type:"Spiel",    ort:"Sportanlage Aabach",   team:"F-Juniorinnen",opponent:"Spielfest Meilen",deadline:"Do 14.05.2026, 18:00", treffpunkt:"08:30 Sportanlage Aabach"},
  {id:141,date:"Mi 13.05.", time:"16:00", type:"Training", ort:"Platz D – Herrliberg", team:"F-Juniorinnen",deadline:"Di 12.05.2026, 18:00"},
  {id:145,date:"Mi 06.05.", time:"16:00", type:"Training", ort:"Platz D – Herrliberg", team:"F-Juniorinnen",deadline:"Di 05.05.2026, 18:00"},
  {id:142,date:"Mi 20.05.", time:"16:00", type:"Training", ort:"Platz D – Herrliberg", team:"F-Juniorinnen",deadline:"Di 19.05.2026, 18:00"},
  {id:143,date:"Mi 27.05.", time:"16:00", type:"Training", ort:"Platz D – Herrliberg", team:"F-Juniorinnen",deadline:"Di 26.05.2026, 18:00"},
  {id:144,date:"Sa 20.06.", time:"09:00", type:"Spiel",    ort:"Sportanlage Aabach",   team:"F-Juniorinnen",opponent:"Spielfest Herrliberg",deadline:"Do 18.06.2026, 18:00", treffpunkt:"08:30 Sportanlage Aabach"},
];
/* Initial Zusagen/Absagen pro Ereignis und Spieler-ID
   status: "zu"|"ab"|"fraglich"|null  */
const ATT_INITIAL=(()=>{
  const d={};
  /* Helper to get roster IDs for a team */
  const teamIds=(team)=>ROSTER.filter(p=>(p.teams||[]).includes(team)&&!p.rolle).map(p=>p.id).slice(0,12);

  const today="2026-05-23";
  const parseD2=(d)=>{const c=(d||"").replace(/^[A-Za-zÄÖÜäöü]{2,3}\s+/,"").trim();const p=c.split(".");return p.length>=2?`2026-${p[1].padStart(2,"0")}-${p[0].padStart(2,"0")}`:"";}
  ATT_EVENTS.forEach(ev=>{
    d[ev.id]={};
    const pids=ev.team==="Alle"?[...teamIds("Cc-Junioren"),...teamIds("1. Mannschaft Herren").slice(0,4)]:teamIds(ev.team);
    const isPastEv=parseD2(ev.date)<today;
    pids.forEach((pid,i)=>{
      if(ev.type==="Training"&&!isPastEv){
        d[ev.id][pid]={status:"zu",note:""};
      } else if(isPastEv){
        /* Vary per event using event id as seed so different players miss different events */
        const seed=(ev.id*37+pid*13)%100;
        d[ev.id][pid]={status:seed<75?"zu":"ab",note:""};
      } else {
        const seed2=(ev.id*53+pid*17)%100;
        d[ev.id][pid]={status:seed2<50?"zu":seed2<65?"fraglich":null,note:""};
      }
    });
    /* Always pre-set the trainer/coach */
    if(ev.team==="Cc-Junioren"){d[ev.id][200]={status:"zu",note:""};}
    if(ev.team==="1. Mannschaft Herren"){d[ev.id][202]={status:"zu",note:""};}
    if(ev.team==="1. Mannschaft Frauen"){d[ev.id][203]={status:"zu",note:""};}
    if(ev.team==="Ca-Junioren"){d[ev.id][204]={status:"zu",note:""};}
  });
  return d;
})();
/* Keep ATT_LOG for backward compat */
const ATT_LOG=[
  {date:"Di 20.05.",type:"Training",present:[1,2,4,5],absent:[3,6]},
  {date:"Sa 17.05.",type:"Spiel",   present:[1,2,3,4,5],absent:[6]},
  {date:"Di 13.05.",type:"Training",present:[1,2,4,5,6],absent:[3]},
  {date:"Sa 10.05.",type:"Spiel",   present:[1,2,3,4,5,6],absent:[]},
  {date:"Di 06.05.",type:"Training",present:[1,4,5],absent:[2,3,6]},
];

const GANTT=[
  {day:"Mo",slots:[{team:"1. Mannschaft Frauen",start:19.5000,end:21.0000,field:"Platz A",color:"#64748B"},{team:"Bb-Junioren",start:17.5000,end:19.0000,field:"Platz C",color:"#2563EB"},{team:"C-Juniorinnen",start:17.0000,end:18.5000,field:"Platz B",color:"#64748B"}]},
  {day:"Di",slots:[{team:"1. Mannschaft Herren",start:20.0000,end:21.5000,field:"Hauptplatz",color:"#7C3AED"},{team:"Ba-Junioren",start:17.5000,end:19.0000,field:"Platz B",color:"#059669"},{team:"Ca-Junioren",start:17.5000,end:19.0000,field:"Platz A",color:"#C8102E"},{team:"Cc-Junioren",start:17.5000,end:19.0000,field:"Platz A",color:"#C8102E"},{team:"Db-Junioren",start:16.5000,end:17.7500,field:"Platz C",color:"#0891B2"}]},
  {day:"Mi",slots:[{team:"2. Mannschaft Herren",start:19.0000,end:20.5000,field:"Platz A",color:"#0891B2"},{team:"Bb-Junioren",start:17.0000,end:18.5000,field:"Platz B",color:"#2563EB"},{team:"Da-Junioren",start:16.5000,end:17.7500,field:"Platz B",color:"#7C3AED"},{team:"C-Juniorinnen",start:17.0000,end:18.5000,field:"Platz C",color:"#64748B"},{team:"F-Juniorinnen",start:15.5000,end:16.5000,field:"Platz D",color:"#059669"}]},
  {day:"Do",slots:[{team:"1. Mannschaft Herren",start:20.0000,end:21.5000,field:"Hauptplatz",color:"#7C3AED"},{team:"1. Mannschaft Frauen",start:19.5000,end:21.0000,field:"Platz B",color:"#64748B"},{team:"Db-Junioren",start:16.5000,end:17.7500,field:"Platz C",color:"#0891B2"}]},
  {day:"Fr",slots:[{team:"2. Mannschaft Herren",start:19.0000,end:20.5000,field:"Platz A",color:"#0891B2"},{team:"Ba-Junioren",start:17.0000,end:18.5000,field:"Platz A",color:"#059669"},{team:"Ca-Junioren",start:17.5000,end:19.0000,field:"Platz B",color:"#C8102E"},{team:"Cc-Junioren",start:17.5000,end:19.0000,field:"Platz A",color:"#C8102E"}]},
  {day:"Sa",slots:[{team:"Da-Junioren",start:10.0000,end:11.2500,field:"Platz C",color:"#7C3AED"},{team:"F-Juniorinnen",start:9.0000,end:10.0000,field:"Platz D",color:"#059669"}]},
  {day:"So",slots:[]},
];
...
const LOCKERS=[
  {name:"Garderobe 1",assignments:[
    {team:"Cc-Junioren",start:9,end:11,day:"Sa",type:"Heim",color:R},
    {team:"A-Junioren",start:17,end:19.5,day:"Mi",type:"Heim",color:GN},
  ]},
  {name:"Garderobe 2",assignments:[
    {team:"FC Küsnacht",start:9,end:11,day:"Sa",type:"Gast",color:"#888"},
  ]},
...
function TrainingGantt({team}){
  const START=15,END=22,H=52;
  const fmt=v=>v%1===0?`${v}:00`:Math.floor(v)+":30";
  return(
    <div>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
        <div>
          <div style={{fontSize:13,color:"#888"}}>KW 21 · 19.05.–25.05.2026</div>
          {team&&(()=>{
            const mySlots=GANTT.flatMap(d=>d.slots.filter(s=>s.team===team).map(s=>({day:d.day,...s})));
            if(mySlots.length===0) return null;
            return <div style={{fontSize:12,color:BK,fontWeight:600,marginTop:2}}>
              {team}: {mySlots.map(s=>`${s.day} ${s.field} ${Math.floor(s.start)}:${s.start%1?"30":"00"}–${Math.floor(s.end)}:${s.end%1?"30":"00"} Uhr`).join(" · ")}
            </div>;
          })()}
        </div>
      )}
        <div style={{display:"flex",gap:6}}><Btn>← KW 20</Btn><Btn>KW 22 →</Btn></div>
      </div>
      <Card style={{padding:0,overflowX:"auto"}}>
        <div style={{minWidth:580}}>
          <div style={{display:"grid",gridTemplateColumns:"52px repeat(7,1fr)",background:GR,borderBottom:`0.5px solid ${GB}`}}>
            <div/>
            {GANTT.map((d,i)=>(
              <div key={i} style={{padding:"8px 0",textAlign:"center",fontWeight:700,fontSize:11,borderLeft:`0.5px solid ${GB}`,color:d.slots.length?BK:"#ccc"}}>{d.day}</div>
            ))}
          </div>
          <div style={{display:"grid",gridTemplateColumns:"52px repeat(7,1fr)"}}>
            <div style={{borderRight:`0.5px solid ${GB}`,background:"#fafaf8"}}>
              {Array.from({length:END-START+1},(_,i)=>(
                <div key={i} style={{height:H,paddingRight:6,paddingTop:4,fontSize:9,color:"#ccc",textAlign:"right",borderTop:i>0?`0.5px solid ${GB}`:"none"}}>{START+i}:00</div>
              ))}
            </div>
            {GANTT.map((day,di)=>(
              <div key={di} style={{borderLeft:`0.5px solid ${GB}`,position:"relative",height:H*(END-START)}}>
                {Array.from({length:END-START},(_,i)=>(
                  <div key={i} style={{position:"absolute",top:i*H,left:0,right:0,height:H,borderTop:i>0?`0.5px solid ${GB}`:"none"}}/>
                ))}
                {day.slots.map((s,si)=>{
                  const top=(s.start-START)*H, h=(s.end-s.start)*H-3;
                  const isMyTeam=team&&s.team===team;
                  const dimmed=team&&!isMyTeam;
                  return(
                    <div key={si} style={{position:"absolute",top,left:3,right:3,height:h,background:isMyTeam?s.color:dimmed?"#D1D5DB":s.color,borderRadius:6,padding:"5px 7px",overflow:"hidden",opacity:dimmed?0.35:1,boxShadow:isMyTeam?"0 0 0 2px #fff, 0 0 0 4px "+s.color:"none"}}>
                      <div style={{color:"#fff",fontWeight:isMyTeam?800:700,fontSize:11}}>{s.team}</div>
                      <div style={{color:"rgba(255,255,255,0.85)",fontSize:10}}>{fmt(s.start)}–{fmt(s.end)}</div>
                      <div style={{color:"rgba(255,255,255,0.7)",fontSize:10}}>{s.field}</div>
                    </div>
                  );
                })}
              </div>
      ...
      <InfoBox text="Trainingsabsage: Unter Mein Team → Anwesenheit erfassen. Administration wird automatisch informiert." color={R}/>
    </div>
  );
}
...
export default function App(){
  ...
  const getView=()=>{
    ...
    switch(active){
      ...
      case "training":          return <TrainingGantt/>;
