      ...
      {!loading&&tab==="aussehen"&&(
        <div style={{maxWidth:600}}>
          ...
          <div style={{display:"flex",gap:10,marginTop:16}}>
            ...
            <button onClick={()=>{setAppTheme(THEME_DEFAULT_STATIC);setThemeDirty(false);if(supabase){if(vereinId)supabase.from("vereine").update({theme:THEME_DEFAULT_STATIC}).eq("id",vereinId).then(({error:e})=>{setSaveMsg(e?"Fehler: "+e.message:"Standard gespeichert ✓");setTimeout(()=>setSaveMsg(""),2500);});}}} style={{
