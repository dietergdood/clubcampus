...
function Portal({supabaseClient, slug}: PortalProps){
  ...
  const getView=()=>{
    ...
    switch(active){
      ...
      case "users":             return <PortalverwaltungView initialTab="users" moduleAktiv={moduleAktiv} setModuleAktiv={setModuleAktiv} moduleRechte={moduleRechte} setModuleRechte={setModuleRechte} sb={sb} appTheme={appTheme} setAppTheme={setAppTheme} applyThemeCss={applyThemeCss} vereinId={tenant?.id} dbTeams={dbTeams} setDbTeams={setDbTeams} dbMitglieder={dbMitglieder} benutzerId={dbUser?.id??null}/>;
      ...
      case "schedule":          return <SpielplanModul role={role} sb={sb} vereinId={tenant?.id} kannSchreiben={kannSchreiben} benutzerId={dbUser?.id??null}/>;
      ...
      case "exports":           return <PortalverwaltungView initialTab="api" moduleAktiv={moduleAktiv} setModuleAktiv={setModuleAktiv} moduleRechte={moduleRechte} setModuleRechte={setModuleRechte} sb={sb} appTheme={appTheme} setAppTheme={setAppTheme} applyThemeCss={applyThemeCss} vereinId={tenant?.id} dbTeams={dbTeams} setDbTeams={setDbTeams} dbMitglieder={dbMitglieder} benutzerId={dbUser?.id??null}/>;
      case "sync":              return <PortalverwaltungView initialTab="api" moduleAktiv={moduleAktiv} setModuleAktiv={setModuleAktiv} moduleRechte={moduleRechte} setModuleRechte={setModuleRechte} sb={sb} appTheme={appTheme} setAppTheme={setAppTheme} applyThemeCss={applyThemeCss} vereinId={tenant?.id} dbTeams={dbTeams} setDbTeams={setDbTeams} dbMitglieder={dbMitglieder} benutzerId={dbUser?.id??null}/>;
      case "audit":             return <PortalverwaltungView initialTab="audit" moduleAktiv={moduleAktiv} setModuleAktiv={setModuleAktiv} moduleRechte={moduleRechte} setModuleRechte={setModuleRechte} sb={sb} appTheme={appTheme} setAppTheme={setAppTheme} applyThemeCss={applyThemeCss} vereinId={tenant?.id} dbTeams={dbTeams} setDbTeams={setDbTeams} dbMitglieder={dbMitglieder} benutzerId={dbUser?.id??null}/>;
