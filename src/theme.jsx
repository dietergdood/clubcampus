...
.cc-btn-ghost-sm{display:inline-flex;align-items:center;gap:4px;padding:3px 10px;border-radius:6px;border:0.5px solid var(--border-strong);background:var(--surface1);font-size:12px;font-weight:500;color:var(--text);cursor:pointer}
.cc-btn-ghost-sm:hover{background:var(--cc-hover)}
