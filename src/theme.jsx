...
.cc-members-group-hdr{cursor:pointer}.cc-members-group-hdr td{padding:9px 14px;background:#EBEBEB;border-top:1px solid var(--border);border-bottom:0.5px solid var(--border)}.cc-members-group-hdr:hover td{background:#E0E0E0}.cc-members-group-hdr-inner{display:flex;align-items:center;gap:8px}.cc-members-group-hdr-chevron{color:var(--sub);flex-shrink:0}.cc-members-group-hdr-name{font-size:11px;font-weight:600;color:var(--text);text-transform:uppercase;letter-spacing:0.07em}.cc-members-group-hdr-count{font-size:10px;color:var(--sub);font-weight:500;background:var(--border);border-radius:4px;padding:1px 5px;margin-left:2px}.cc-members-group-hdr-sub td{padding:7px 14px}
/* Mobile Liste */
