...
.cc-table-wrap{background:var(--surface);overflow:hidden;border-radius:0 0 11px 11px}
.cc-table-wrap-inner{overflow-x:auto;overflow-y:auto;width:100%;max-height:calc(100vh - 268px);position:relative;z-index:0}
