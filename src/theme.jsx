...
.cc-ml-dropdown-section-lbl{padding:16px 12px 5px;font-size:11px;font-weight:600;color:var(--sub);text-transform:uppercase;letter-spacing:0.05em;border-top:0.5px solid var(--border)}
